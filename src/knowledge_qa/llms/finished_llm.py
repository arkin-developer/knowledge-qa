...
class FinishedLLM:
    ...
    def generate(self, query: str, answer: str) -> FinishedState:
        """根据问题生成回答"""
        try:
...
if __name__ == "__main__":
    ...
    context = {
        ...
        "answer": """根据提供的知识库内容，我无法找到相关信息来回答您的问题。知识库中未提及"韩立"、"七玄门"
或"记名弟子初次考验"的相关内容。"""
    }
    finished_state = finished_llm.generate(context["query"], context["answer"])
